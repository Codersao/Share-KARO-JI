...
<?php foreach ($public as $f): ?>
    <div class="card">
        ...
        <?php if ($f['media']): ?>
        <div class="preview" id="preview-<?= $f['id'] ?>">
            ...
            <?php elseif (in_array($f['ext'], ['mp4','webm'])): ?>
                <video controls preload="metadata" id="vid-<?= $f['id'] ?>">
            ...
            <?php elseif (in_array($f['ext'], ['mp3','wav'])): ?>
                ...
                <div style="display:flex;gap:8px;align-items:center;">
                    <button class="btn" onclick="togglePlay('<?= $f['id'] ?>')"><i class="fa fa-play"></i> Play/Pause</button>
